        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">@trans('backsite.major.create')</h4>
                            <form method="post" action="{{ route(getLang(). 'backsite.major.store') }}" class="form-horizontal">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" class="form-control" placeholder="@trans('backsite.major')" name="major" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <textarea class="form-control" name="desc" placeholder="@trans('backsite.major.desc')"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
