...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="post" action="{{ route('backsite.year.update', $item->id) }}" class="form-horizontal">
                        @csrf
                        @method('PUT')
                        <div class="card-header card-header-text" data-background-color="rose">
                            <h4 class="card-title">Update Year {{ $item->year }}</h4>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group label-floating is-empty">
                                        ...
                                        <input type="number" class="form-control" placeholder="Year" name="year" required value="{{ $item->year }}">
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="row">
