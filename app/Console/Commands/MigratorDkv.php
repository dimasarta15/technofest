...
use App\Models\OldTechnofest\TbSemester;
...
class MigratorDkv extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'migratedkv:start {--type=}';
     ...
     * @var string
     */
    protected $description = 'Migrate data dkvolution CI to Laravel';
    ...
    public function migrateProjectAuthor()
    {
        ...
        try {
            ...
            foreach ($tk as $key => $karya) {
                ...
                $major = $karya->TbProdi->PRODI ?? dd($karya->toArray());
                ...
                $project->semester_id = $this->_getSemesterId($semester);
    ...
    private function _getSemesterId($id)
    {
        // oldId => newId
        $arr = [
            1 => 1,
